...
#import "MTPresentOneTransition.h"
#import "UIView+FrameChange.h"

@interface MTPresentOneTransition ()

@property(nonatomic,assign)MTPresentOneTransitionType type;

@end

@implementation MTPresentOneTransition
...
-(NSTimeInterval)transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext {
    return self.type == MTPresentOneTransitionTypePresent ? 0.5 : 0.25;
}

-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    //分开动画
    switch (_type) {
        case MTPresentOneTransitionTypePresent:
            [self presnetAnimation:transitionContext];
            break;
        case MTPresentOneTransitionTypeDismiss:
...
-(void)presnetAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
